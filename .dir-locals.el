  ...
  . ((eval . 
	   (let ((unimath-topdir (expand-file-name (locate-dominating-file buffer-file-name "UniMath"))))
	     ...
	     (setq coq-prog-args
		   ...
		   `("-quiet" "-emacs" "-noinit" "-indices-matter" "-type-in-type" "-w" "-notation-overridden" "-Q" ,(concat unimath-topdir "UniMath") "UniMath" "-R" ,(concat unimath-topdir "_build/default/UniMath") "UniMath")
		   )
