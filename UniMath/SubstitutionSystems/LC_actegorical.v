  ...
  **)
    ...
    Section Church.
      ...
      Proof.
        ...
        exact tt.
        (**
         Le code "prouve" jusqu'ici : on a 4 buts "sort" générés (qui ne sont pas générés à ce stade dans STLC_actegorical. D'ailleurs, il ne suffit manifestement pas de faire -exact l. -exact l. -exact l. -exact l. (ce que je ne m'explique pas vraiment : pour moi s'il reste  des goals on peut toujours ajouter des bullets pour les prouver.
        **)
      Defined.
